...
Applications that need more control over the user experience around authentication should directly interface with `github.com/pluralsh/oauth/device` and `github.com/pluralsh/oauth/webapp` packages.
